...
function PortraitPrintContent() {
  ...
  return <PortraitPrintDashboard date={params.get('date')} workPeriodId={params.get('workPeriodId')} vehicle={params.get('vehicle')} lang={params.get('lang')} style={params.get('style')} />;
}
