...
const gpsCopy = {
  ...
  'Data-FM matched': ['Data-FM matched', 'พบข้อมูล Data-FM'],
...
const gpsUiText = {
  en: {
    subtitle: 'Review saved jobs and their time-matched Data-FM GPS records.', gpsMatched: 'GPS found', gpsMatchedSub: 'jobs with a Data-FM GPS point', needsAttention: 'Needs attention', needsAttentionSub: 'jobs with no Data-FM GPS point', gpsFound: 'GPS found', noData: 'No GPS data', viewGps: 'View GPS', gpsCoverage: 'Data-FM GPS', lastPosition: 'Last position', samples: 'points',
  },
  th: {
    subtitle: 'ตรวจสอบงานที่บันทึกและข้อมูล GPS จาก Data-FM ที่ตรงตามเวลา', gpsMatched: 'พบข้อมูล GPS', gpsMatchedSub: 'งานที่พบพิกัดจาก Data-FM', needsAttention: 'ต้องตรวจสอบ', needsAttentionSub: 'งานที่ไม่พบพิกัดจาก Data-FM', gpsFound: 'พบข้อมูล GPS', noData: 'ไม่มีข้อมูล GPS', viewGps: 'ดู GPS', gpsCoverage: 'GPS จาก Data-FM', lastPosition: 'ตำแหน่งล่าสุด', samples: 'จุด',
  },
};
const text = {
  en: {
    eyebrowToday: 'TODAY', title: 'Operations reports', subtitle: 'Review, filter, print, and retry every saved vehicle job.', search: 'Search reports', searchPlaceholder: 'Vehicle, device, driver, mode, report ID, GPS, or location', dateRange: 'Date range', allDates: 'All dates', today: 'Today', last7: 'Last 7 days', month: 'This month', custom: 'Custom range', startDate: 'Start date', endDate: 'End date', apply: 'Apply', previousMonth: 'Previous month', nextMonth: 'Next month', report: 'Report ID', vehicle: 'Vehicle', allVehicles: 'All vehicles', device: 'Device', allDevices: 'All devices', driver: 'Driver', allDrivers: 'All drivers', mode: 'Activity', allModes: 'All activities', status: 'Status', allStatuses: 'All statuses', gps: 'Data-FM GPS', allGps: 'All GPS states', sort: 'Sort by', sortHint: 'Shift-click headers to sort by up to three columns.', newest: 'Newest first', oldest: 'Oldest first', clear: 'Clear', refresh: 'Refresh', refreshing: 'Refreshing…', print: 'Print report', printVehicle: 'Print vehicle report', jobs: 'Total jobs', jobsSub: 'in the selected range', active: 'Vehicles operating', activeSub: 'vehicles with saved work', queued: 'GPS lookup pending', queuedSub: 'waiting for Data-FM', cancelled: 'Cancelled jobs', cancelledSub: 'kept in the audit record', activity: 'Job list', date: 'Date', start: 'Start time', end: 'End time', duration: 'Total time', topSpeed: 'Top speed', location: 'Location (GPS)', noJobs: 'No jobs match the current filters.', emptyTitle: 'No jobs recorded yet', emptyBody: 'Connect a tablet to a vehicle, then complete or cancel a job. It will appear here automatically.', noMatchTitle: 'No matching jobs', noMatchBody: 'Try a different search, date range, or filter.', manageFleet: 'Manage fleet', failed: 'Could not load reports.', loading: 'Loading reports…', retry: 'Retry GPS lookup', retrying: 'Looking up…', actions: 'Actions', deviceSamples: 'Data-FM', lastPoint: 'Last point', previous: 'Previous', next: 'Next', page: 'Page', of: 'of', showing: 'Showing', total: 'total', fleet: 'fleet', unknownLocation: 'No GPS point', stationary: 'Stationary', speedUnit: 'km/h',
  },
  th: {
    eyebrowToday: 'วันนี้', title: 'รายงานการวิ่งงาน', subtitle: 'ตรวจสอบ กรอง พิมพ์ และค้นหาข้อมูล GPS ของงานรถที่บันทึก', search: 'ค้นหารายงาน', searchPlaceholder: 'รถ อุปกรณ์ พขร. กิจกรรม รหัสรายงาน GPS หรือสถานที่', dateRange: 'ช่วงวันที่', allDates: 'ทุกวัน', today: 'วันนี้', last7: '7 วันที่ผ่านมา', month: 'เดือนนี้', custom: 'กำหนดช่วงเอง', startDate: 'วันที่เริ่ม', endDate: 'วันที่สิ้นสุด', apply: 'ใช้ช่วงวันที่', previousMonth: 'เดือนก่อนหน้า', nextMonth: 'เดือนถัดไป', report: 'รหัสรายงาน', vehicle: 'เบอร์รถ', allVehicles: 'รถทั้งหมด', device: 'อุปกรณ์', allDevices: 'อุปกรณ์ทั้งหมด', driver: 'พขร.', allDrivers: 'พขร. ทั้งหมด', mode: 'กิจกรรม', allModes: 'กิจกรรมทั้งหมด', status: 'สถานะ', allStatuses: 'สถานะทั้งหมด', gps: 'GPS จาก Data-FM', allGps: 'สถานะ GPS ทั้งหมด', sort: 'เรียงตาม', sortHint: 'กด Shift พร้อมหัวตารางเพื่อเรียงได้สูงสุด 3 คอลัมน์', newest: 'ใหม่ไปเก่า', oldest: 'เก่าไปใหม่', clear: 'ล้างตัวกรอง', refresh: 'รีเฟรช', refreshing: 'กำลังรีเฟรช…', print: 'พิมพ์รายงาน', printVehicle: 'พิมพ์รายงานรถ', jobs: 'งานทั้งหมด', jobsSub: 'ในช่วงวันที่ที่เลือก', active: 'รถที่วิ่งงาน', activeSub: 'รถที่มีงานบันทึก', queued: 'รอค้นหา GPS', queuedSub: 'กำลังรอข้อมูล Data-FM', cancelled: 'งานที่ยกเลิก', cancelledSub: 'เก็บไว้ในประวัติการตรวจสอบ', activity: 'รายการงาน', date: 'วันที่', start: 'เวลาเริ่ม', end: 'เวลาจบ', duration: 'รวมเวลา', topSpeed: 'ความเร็วสูงสุด', location: 'สถานที่ (GPS)', noJobs: 'ไม่พบงานตามตัวกรองนี้', emptyTitle: 'ยังไม่มีงานที่บันทึก', emptyBody: 'เชื่อมต่อแท็บเล็ตกับรถ แล้วจบหรือยกเลิกงาน รายการจะปรากฏที่นี่โดยอัตโนมัติ', noMatchTitle: 'ไม่พบงานที่ตรงกัน', noMatchBody: 'ลองเปลี่ยนคำค้นหา ช่วงวันที่ หรือตัวกรอง', manageFleet: 'จัดการรถ', failed: 'ไม่สามารถโหลดรายงานได้', loading: 'กำลังโหลดรายงาน…', retry: 'ค้นหา GPS อีกครั้ง', retrying: 'กำลังค้นหา…', actions: 'การดำเนินการ', deviceSamples: 'Data-FM', lastPoint: 'จุดล่าสุด', previous: 'ก่อนหน้า', next: 'ถัดไป', page: 'หน้า', of: 'จาก', showing: 'แสดง', total: 'ทั้งหมด', fleet: 'คันทั้งหมด', unknownLocation: 'ไม่มีพิกัด GPS', stationary: 'จอดนิ่ง', speedUnit: 'กม./ชม.',
  },
};
...
function displayGps(value, lang) { return translated(value, gpsCopy, lang); }
      ...
      {open ? <>
        ...
        <section className="date-popover" role="dialog" aria-label={t.dateRange}>
          ...
          <div className="calendar-grid" role="grid" aria-label={monthLabel}>
            {weekdays.map((day, index) => <span className="calendar-weekday" key={`${day}-${index}`} role="columnheader">{day}</span>)}
            {calendarDays(cursorMonth).map((day, index) => day
              ? <button
                ...
                type="button"
                role="gridcell"
                aria-selected={day === draftStart || day === draftEnd || Boolean(draftStart && draftEnd && day > draftStart && day < draftEnd)}
                onClick={() => chooseDay(day)}
              >{Number(day.slice(-2))}</button>
              : <span key={`blank-${index}`} role="gridcell" />)}
          </div>
          <div className="date-popover-footer"><span>{rangeLabel(draftStart, draftEnd, t, lang)}</span><button className="primary small-button" type="button" onClick={() => { onChange(draftStart, draftEnd || draftStart); setOpen(false); }}>{t.apply}</button></div>
        </section>
      </> : null}
    </div>
  );
  ...
  return (
    <main className="main report-workspace" id="main-content" tabIndex={-1}>
      ...
      <section className="panel report-panel" aria-busy={loading || search !== deferredSearch}>
        ...
        {visibleReports.length ? <div className="table-wrap" tabIndex={0} aria-label={lang === 'en' ? 'Scrollable saved jobs table' : 'ตารางงานที่บันทึก เลื่อนได้'}>
          <table className="reports-table">
            ...
            <thead><tr>{columns.map(([key, label]) => {
              ...
              return <th key={key} scope="col" aria-sort={sortKey === key ? (sortDirection === 'asc' ? 'ascending' : 'descending') : 'none'}><button className="table-sort" type="button" title={t.sortHint} onClick={event => changeSort(key, event)}>{label}{columnSort ? ` ${columnSort.direction === 'asc' ? '↑' : '↓'}${sorts.length > 1 ? sortIndex + 1 : ''}` : ''}</button></th>;
            ...
            <tbody>{renderedReports.map(report => <tr key={report.id} className={`${report.status === 'Cancelled' ? 'row-cancelled' : isLookupPending(report) ? 'row-queued' : ''} ${selectedReport?.id === report.id ? 'row-selected' : ''}`}>
              ...
              <td>{formatTime(report.startTime, lang)}</td>
              <td>{formatTime(report.endTime, lang)}</td>
              ...
              <td className="gps-coverage-cell"><button type="button" className={`coverage-state coverage-${reportCoverage(report).state}`} onClick={() => setSelectedReport(report)}>{coverageLabel(report, g)}</button><small>{Number(report.deviceGpsSamples) || 0} {g.samples}</small></td>
        ...
        {visibleReports.length ? <div className="report-cards" aria-label={lang === 'en' ? 'Saved jobs' : 'งานที่บันทึก'}>
          {renderedReports.map(report => <article className={`report-card ${report.status === 'Cancelled' ? 'row-cancelled' : isLookupPending(report) ? 'row-queued' : ''} ${selectedReport?.id === report.id ? 'row-selected' : ''}`} key={report.id} aria-label={`${t.report} ${report.id}`}>
            ...
            <dl><div><dt>{t.driver}</dt><dd>{report.driverName || '—'}{report.driverId ? <small className="secondary-line">{report.driverId}</small> : null}</dd></div><div><dt>{t.device}</dt><dd className="device-id">{report.deviceId || '—'}</dd></div><div><dt>{t.mode}</dt><dd>{displayMode(report.mode, lang)}</dd></div><div><dt>{t.date}</dt><dd>{report.startTime ? formatReportDate(reportDateKey(report.startTime), lang) : '—'}</dd></div><div><dt>{t.start} – {t.end}</dt><dd>{formatTime(report.startTime, lang)} – {formatTime(report.endTime, lang)}</dd></div><div><dt>{t.duration}</dt><dd>{report.duration || '—'}</dd></div><div><dt>{t.topSpeed}</dt><dd className={reportSpeed(report) > 90 ? 'speed-alert' : undefined}>{reportSpeed(report) == null ? '—' : reportSpeed(report) === 0 ? t.stationary : `${reportSpeed(report)} ${t.speedUnit}`}</dd></div><div><dt>{g.gpsCoverage}</dt><dd><button type="button" className={`coverage-state coverage-${reportCoverage(report).state}`} onClick={() => setSelectedReport(report)}>{coverageLabel(report, g)}</button></dd></div><div className="card-location"><dt>{g.lastPosition}</dt><dd>{reportLocation(report, t.unknownLocation)}{gpsDetails(report, t, lang)}</dd></div></dl>
            <div className="card-actions">{canRetry(report) ? <button className="retry-button" type="button" disabled={Boolean(retryingId)} onClick={() => retryReport(report.id)}>{retryingId === report.id ? t.retrying : t.retry}</button> : null}<button className="view-gps-button" type="button" onClick={() => setSelectedReport(report)}>{g.viewGps}</button><button className="print-row-button" type="button" onClick={() => printVehicle(report)}>{t.printVehicle}</button></div>
          </article>)}
        </div> : null}
