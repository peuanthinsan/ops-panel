...
export type ActiveJob={jobId?:string;vehicleNumber:string;deviceId:string;selected:string;routeName?:string|null;initiatedAt?:number;startedAt:number;awaitingMovement?:boolean;driverName?:string|null;driverId?:string|null;pendingReport?:JobReportInput};
